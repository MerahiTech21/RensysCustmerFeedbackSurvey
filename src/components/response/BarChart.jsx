  ...
  return (
      ...
      <div className={"container-fluid d-flex w-100 h-50 justify-content-space mb-1 "}>
        ...
        <div className={classes.bar + "col-5 w-50 mx-0 my-0 py-0 bg-white"}>
          <div className={` h-100  bg-primary`} style={{width:Math.round(totalRespondent *100 / totalResponse)}}> </div>
        </div>
        <div className="col-2 d-flex ms-2">
          <div className="h-50 mx-0 ">{Math.round(totalRespondent *100 /totalResponse)}%</div>
